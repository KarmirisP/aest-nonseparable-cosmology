...
\appendix
\input{appendices/appA_action_variation}
\input{appendices/appB_flrw_current}
\input{appendices/appC_linear_perturbations}
\input{appendices/appD_dirac}
\input{appendices/appE_cutoff}
\input{appendices/appF_class}
\input{appendices/appG_likelihood}
\input{appendices/appH_reproducibility}
