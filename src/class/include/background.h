...
struct background
{
  ...
  double Omega0_aest;      /**< present AeST effective gravitational-matter density */
  double aest_KB;          /**< AeST vector kinetic coefficient; stored now for later perturbations */
  double aest_K2;          /**< Cosh K_2 */
  double aest_Q0;          /**< Cosh Q_0 in Mpc^-1 */
  double aest_Z0;          /**< Cosh Z_0 in Mpc^-1 */
  double aest_x0;          /**< derived x(a=1)=I0/(2 K2 Z0) */
  double aest_I0;          /**< derived first-integral constant, Mpc^-1 */
  ...
  double Omega0_vcdm_native; /**< MODEL184 VCDM */
  int vcdm_order;              /**< MODEL184 VCDM polynomial order: 2, 3, 4 */
  double vcdm_s1;              /**< MODEL184 VCDM normalized shape s1 = c1 / Omega_V0 */
  double vcdm_s2;              /**< MODEL184 VCDM normalized shape s2 = c2 / Omega_V0 */
  double vcdm_s3;              /**< MODEL184 VCDM normalized shape s3 = c3 / Omega_V0 */
  double vcdm_s4;              /**< MODEL184 VCDM normalized shape s4 = c4 / Omega_V0 */
  double vcdm_s5;              /**< MODEL184 VCDM normalized shape s5 = c5 / Omega_V0 */
  double vcdm_s6;              /**< MODEL184 VCDM normalized shape s6 = c6 / Omega_V0 */
  ...
  /* MODEL177_AEST_BACKGROUND_V1 */
  int index_bg_rho_aest;
  int index_bg_p_aest;
  int index_bg_w_aest;
  int index_bg_ca2_aest;
  int index_bg_Q_aest;
  /* END MODEL177_AEST_BACKGROUND_V1 */
  ...
  short has_aest;      /**< MODEL177_AEST_BACKGROUND_V1 */
  ...
  short has_vcdm_native; /**< MODEL184 VCDM */
