...
struct perturbations_vector
{
  ...
  int index_pt_delta_aest; /**< AeST density contrast */
  int index_pt_theta_aest; /**< AeST CLASS velocity divergence */
  int index_pt_chi_aest;   /**< chi = varphi + Q alpha */
  int index_pt_E_aest;     /**< E = alpha_dot + Psi */
